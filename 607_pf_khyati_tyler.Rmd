...
### Remove 1st row as it just provides the column name description
```{r}
#raw_dt_cens_inc <- raw_dt_cens_inc %>%  filter(!row_number() %in% #c(1))
```
...
The map shows that most of the top 100 least affordable counties are in West namely in California, Washington etc. There are some pockets in Souther US such as Florida and Texas too that have low affordability.
